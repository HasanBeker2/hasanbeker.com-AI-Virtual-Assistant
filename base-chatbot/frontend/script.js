const apiUrl = 'https://hasanbeker.com/wp-json/myapi/v1/chat-bot/'; //change this Url
const botConfigurationUrl = 'https://hasanbeker.com/wp-json/myapi/v1/chat-bot-config'; //change this Url
